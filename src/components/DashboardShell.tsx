...
export default function DashboardShell({ email, onSignOut }: { email?: string; onSignOut: () => void }) {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-[1400px] px-4 py-8 sm:px-6 lg:px-8">
      <div className="lg:grid lg:grid-cols-[300px_1fr] lg:gap-6">
        ...
        <main className="mt-6 lg:mt-0">
            ...
            <div className="flex items-center gap-2.5">
              <div className="glass-soft flex items-center gap-2 rounded-full px-3 py-2">
                ...
                <input
                  ...
                  className="w-28 bg-transparent text-sm text-slate-100 outline-none placeholder:text-slate-500 focus:w-40 sm:w-40 sm:focus:w-56"
          ...
          {/* Hero */}
          <section className="glass mb-6 flex flex-wrap items-center justify-between gap-4 rounded-3xl px-6 py-5">
            <HeroStatus />
