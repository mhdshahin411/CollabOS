...
// Claude extraction can take a few seconds; don't let a slow call hit the
...
export async function POST(req: NextRequest) {
  ...
  // ingested, do nothing — no second Claude call, no re-flipping is_read.
  ...
  if (payload.external_thread_id) {
    ...
    if (lookupError) {
      ...
      // Claude call with a retryable status instead of silently creating a
