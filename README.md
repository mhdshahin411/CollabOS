...
- **AI extraction** — Gemini (`gemini-2.5-flash`, structured JSON output) pulls out brand, budget, deliverables, deadline, priority, and a CRM summary. Non-deal messages (spam, fan mail) are skipped.
